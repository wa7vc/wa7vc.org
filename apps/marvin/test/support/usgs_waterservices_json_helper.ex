defmodule Marvin.USGSWaterservicesJsonHelper do

  def single_parsed_value_object do
    {:ok, parsed} = Jason.decode(
    """
    {
      "value": "98.5",
      "qualifiers": [
  ...
  def single_parsed_timeseries_object do
    {:ok, parsed} = Jason.decode(
    """
    {
      "sourceInfo": {
  ...
  def single_parsed_timeseries_object_with_no_values do
    {:ok, parsed} = Jason.decode(
    """
    {
      "sourceInfo": {
  ...
  def list_of_parsed_timeseries_objects() do
    {:ok, parsed} = Jason.decode(
    """
    {"objects": [
    {
  ...
  # so it should provide a good full example of the JSON that needs to be parsed.
  # The only thing it doesn't include is a -999999 "no values" response.
  def full_json_example do
    """
    {
